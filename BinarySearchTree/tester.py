...
sys.stdout=  open('AdvancedDataStructures/BinarySearchTree/result.out', 'w')
f = open("AdvancedDataStructures\BinarySearchTree\input.in")
...
for i in range(n):
    ...
    if c==4:
        print(tree.firstBelow(a))
    if c==5:
        print(tree.firstAfter(a))
    if c==6:
        printBSTBetween(tree.root,a,b)
        print()
